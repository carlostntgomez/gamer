                ...
                <div class="footer-list">
                    <ul class="footer-ul">
                        ...
                        <li class="footer-li"  data-animate="animate__fadeInUp">
                            <ul class="ftlist-ul">
                                <li class="ftlist-li">
                                    <h6 class="ftlist-title">Categorías</h6>
                        ...
                        <li class="footer-li" data-animate="animate__fadeInUp">
                            <ul class="ftlist-ul">
                                <li class="ftlist-li">
                                    <h6 class="ftlist-title">Atención al cliente</h6>
                                    <a href="#footer-extras" class="ftlist-title" data-bs-toggle="collapse" aria-expanded="false">
                                        <span>Atención al cliente</span><span><i class="fa-solid fa-plus"></i></span>
                                    </a>
                        ...
                        <li class="footer-li footer-content-info" data-animate="animate__fadeInUp">
                            <ul class="ftlist-ul">
                                <li class="ftlist-li">
                                    <h6 class="ftlist-title">Suscríbete a nuestro boletín</h6>
                                    <div class="footer-content">
                                        <div class="footer-info">
                                            <p>Suscríbete al boletín para recibir las últimas actualizaciones.</p>
                                        </div>
                                            ...
                                            <form method="post" id="contact_form" class="contact-form">
                                                ...
                                                <div class="subscribe-block">
                                                    ...
                                                    <div class="email-submit">
                                                        <button type="submit" class="btn btn-style" name="commit" id="Subscribe">Suscribirse</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
