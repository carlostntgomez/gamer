                    ...
                    <div class="col">
                        ...
                        <div class="content-qa-banner">
                            <div class="banner-image banner-hover" data-animate="animate__fadeInUp">
                                <img src="{{ asset('img/other-pages/faq.jpg') }}" class="img-fluid" alt="faq">
                            </div>
                            <div class="que-ans">
                                ...
                                <li class="desk-wrap">
                                    <div class="help-desk-info">
                                        ...
                                        <div class="help-desk-text">
                                            ...
                                            <p data-animate="animate__fadeInUp">Lorem ipsum is simply dummy text of the simply dummy typesetting industry ipsum.</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="desk-wrap">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="section-capture">
                                <!-- ret title start -->
                                <div class="section-title">
                                    <h2 data-animate="animate__fadeInUp"><span>Return policy</span></h2>
                                </div>
                            </div>
                            <div class="que-ans">
                                <ul class="accordian-ul">
