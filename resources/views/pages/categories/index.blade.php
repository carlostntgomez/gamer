                    ...
                    <div class="row">
                        <div class="breadcrumb-index">
                            ...
                            <ul class="breadcrumb-ul">
                                ...
                                <li class="breadcrumb-li">
                                    <span class="breadcrumb-text">Categorías</span>
                                </li>
                            </ul>
                            <!-- breadcrumb-list end -->
                        </div>
                        ...
                        <div class="pro-grli-wrapper left-side-wrap">
                            <div class="pro-grli-wrap product-grid">
                                <div class="collection-img-wrap">
                                    <h6 data-animate="animate__fadeInUp" class="st-title">Categorías ({{ $allCategories->count() }})</h6>
                                    <!-- collection info start -->
                                    @if($category && $category->banner_path)
                                    <div class="collection-info">
                                        <div class="collection-image" data-animate="animate__fadeInUp">
                                            <img src="{{ Storage::url($category->banner_path) }}" class="img-fluid" alt="{{$category->name}}">
                                        </div>
                                    </div>
                                    @endif
                                    <!-- collection info end -->
                                                                ...
                                                                <ul class="brand-ul scrollbar">
                                                                    ...
                                                                    <li class="cat-checkbox" data-animate="animate__fadeInUp">
                                                                        <label class="checkbox-label">
                                                                            <input type="checkbox" class="cust-checkbox" onchange="window.location.href='{{ route('categories.show', $cat) }}'">
                                                        ...
                                                        <div class="shop-sidebar">
                                                            ...
                                                            <div class="collapse show shop-element" id="collapse-6">
                                                                <ul class="brand-ul scrollbar">
                                                                    ...
                                                                    <li class="cat-checkbox" data-animate="animate__fadeInUp">
                                                                        <label class="checkbox-label">
                                                                            <input type="checkbox" class="cust-checkbox" name="brands[]" value="{{ $brand->id }}" onchange="this.form.submit()">
                                                                            <span class="check-name">{{ $brand->name }}</span>
                                                                            <span class="count-check">({{ $brand->products_count }})</span>
                                                                            <span class="cust-check"></span>
                                                                        </label>
                                                                    </li>
                                                                    @endforeach
    ...
    <script>
        $( function() {
            $( "#slider-range" ).slider({
                ...
                min: {{ $minPrice }},
                max: {{ $maxPrice }},
                values: [ {{ request()->get('min_price', $minPrice) }}, {{ request()->get('max_price', $maxPrice) }} ],
