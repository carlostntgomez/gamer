                ...
                <div class="col">
                    <div class="checkout-area">
                        ...
                        <div class="billing-area">
                            <form onsubmit="return false;"> <!-- Main form for layout -->
                            ...
                            <div class="billing-details">
                                <form onsubmit="return false;">
                                    ...
                                    <ul class="shipping-form pro-submit">
                                        ...
                                        <li class="comment-area" data-animate="animate__fadeInUp"><label>Notas del pedido (opcional)</label><textarea form="checkout-form" name="notes" rows="5" cols="80" placeholder="Notas sobre tu pedido. Ej: Dejar en portería.">{{ old('notes') }}</textarea></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="order-area">
                            ...
                            <div class="checkout-btn" style="display: flex; gap: 10px; flex-wrap: wrap;">
