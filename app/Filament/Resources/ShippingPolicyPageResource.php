...
use App\Filament\Resources\ShippingPolicyPageResource\Pages;
use App\Models\Page;
use Filament\Forms;
...
class ShippingPolicyPageResource extends Resource
{
    ...
    protected static ?string $pageSlug = 'shipping-policy';
    protected static ?string $navigationLabel = 'Página: Política de Envío';
    protected static ?string $modelLabel = 'Página: Política de Envío';
    protected static ?string $pluralModelLabel = 'Página: Política de Envío';
            ...
            ->schema([
                Forms\Components\Group::make()
                    ->schema([
                        ...
                        Forms\Components\Section::make('Contenido "Política de Envío"')
                            ->description('Edita las secciones específicas de la página "Política de Envío".')
                            ->schema([
                                Forms\Components\RichEditor::make('main_content')
                                    ->label('Contenido Principal')
                                    ->maxLength(65535)
                                    ->fileAttachmentsDirectory('page-attachments/shipping-policy')
                                    ->columnSpanFull(),
                                Forms\Components\Repeater::make('policy_items')
                                    ...
                                    ->schema([
                                        ...
                                        Forms\Components\RichEditor::make('answer')
                                            ...
                                            ->required()
                                            ->maxLength(65535)
                                            ->fileAttachmentsDirectory('page-attachments/shipping-policy-qa'),
                                    ])
                                    ->minItems(1)
                                    ->collapsible()
    ...
    {
        return [
            'index' => Pages\ListShippingPolicyPages::route('/'),
            'create' => Pages\CreateShippingPolicyPage::route('/create'),
            'view' => Pages\ViewShippingPolicyPage::route('/{record}'),
            'edit' => Pages\EditShippingPolicyPage::route('/{record}/edit'),
        ];
    }
}
